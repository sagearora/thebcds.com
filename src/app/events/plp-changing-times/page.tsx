...
export default function PlpChangingTimesPage() {
  const event = allEvents.find(
    (evt) => evt.slug === "plp-changing-times" || evt.id === 6,
  );
  ...
  return (
    <SitePage>
      {/* Course introduction */}
      <section className="site-hero site-course-hero">
            ...
            <div className="flex flex-col lg:flex-row gap-10 lg:items-start">
              <div className="flex-1 space-y-6">
                <p className="text-lg md:text-xl text-[var(--c-cloud)] max-w-2xl leading-relaxed">
                  Join {event.primarySpeakerName ?? "our expert speakers"} for
                  an in-depth, Category 1 PLP course focused on navigating
                  evolving professional liability expectations in modern
                  practice.
                </p>

                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-4">
                  <div className="space-y-1">
                    <div className="eyebrow text-[var(--c-cloud)] opacity-80">
                      Date
                    </div>
              ...
              <div className="w-full lg:max-w-md lg:self-stretch">
                <div className="bg-[var(--c-paper)] text-[var(--c-ink)] rounded-[var(--radius-card)] shadow-[var(--shadow-card)] p-6 sm:p-8 space-y-4 max-w-md ml-auto lg:ml-0">
                  ...
                  <p className="text-sm text-[var(--c-steel)] leading-relaxed">
                    A focused evening course designed for dentists who want to
                    stay ahead of changing PLP requirements, understand
                    real-world case studies, and protect their practice with
                    confidence.
                  </p>
        ...
        <div className="container max-w-6xl">
          ...
          <div className="bg-white rounded-[var(--radius-card)] shadow-[var(--shadow-card)] p-8 md:p-10 space-y-6">
            <p className="text-base md:text-lg text-[var(--c-steel)] leading-relaxed">
              Professional liability protection (PLP) continues to evolve as
              dentistry adapts to new technologies, patient expectations, and
              regulatory updates. This Category 1 course is designed to help you
              understand how these changes affect your everyday clinical
              decision-making, documentation, communication, and risk
              management.
            </p>
            <p className="text-base md:text-lg text-[var(--c-steel)] leading-relaxed">
              Through real-world scenarios and practical discussion, you&apos;ll
              leave with a clearer understanding of how to protect yourself and
              your team while continuing to deliver excellent patient care.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4">
              <div className="space-y-3">
                ...
                <ul className="space-y-2 text-sm text-[var(--c-steel)]">
                  <li>
                    • Recognize common PLP risk areas in day-to-day practice.
                  </li>
                  <li>
                    • Strengthen records and informed consent communication.
                  </li>
                  <li>
                    • Navigate complaints, claims, and college investigations.
                  </li>
        ...
        <div className="container max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <article className="bg-white rounded-[var(--radius-card)] shadow-[var(--shadow-card)] p-8 space-y-5">
              ...
              <p className="text-sm text-[var(--c-steel)] leading-relaxed">
                Dr. Hong brings extensive experience in professional liability
                and risk management, helping dentists understand how evolving
                expectations impact real clinical practice.
              </p>
              <Link
            ...
            <article className="bg-white rounded-[var(--radius-card)] shadow-[var(--shadow-card)] p-8 space-y-5">
              ...
              <p className="text-sm text-[var(--c-steel)] leading-relaxed">
                Dr. Qureshi offers a grounded, practical perspective on
                navigating PLP questions, documentation, and communication with
      ...
      {/* Closing CTA */}
      <section className="home-cta site-course-cta">
        <div className="container max-w-6xl text-center space-y-6">
          <div className="eyebrow text-[var(--c-neon)]">Secure your seat</div>
          ...
          <p className="text-lg text-[var(--c-cloud)] max-w-2xl mx-auto">
            Space is limited. Reserve now to make sure you and your team stay
            current on evolving professional liability expectations.
          </p>
